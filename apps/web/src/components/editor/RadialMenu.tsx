...
export const RadialMenu: React.FC = () => {
  ...
  const items: RadialItem[] = useMemo(() => {
    if (context === 'empty') {
      ...
      const emptyItems: RadialItem[] = [
        ...
        },
        {
          ...
          action: () => { toggleAdvancedMode(); close(); },
        },
        {
          id: 'wall',
          label: 'Muro',
    ...
    return singleItems;
  }, [context, ctx, currentIntent, intentEnabled, setActiveTool, duplicateItem, removeItem, saveToHistory, updateItem, groupSelection, ungroupSelection, setCatalogPanelState, toggleAdvancedMode, undo, close]);
